...
```bash
git clone https://github.com/your-username/Pollution&DiseaseNYC.git
...
### 6. Open the notebook
Open `Notebooks/final_project.ipynb` in Jupyter or VSCode and run all cells.
...
**Jennifer Poueymirou**
The Knowledge House — Data Science Cohort
June 2026